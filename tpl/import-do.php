...
?>
  ...
  <script>
    ...
    var gwapi_recipient_groups = <?php echo isset($_POST['gwapi_recipient_groups']) ? json_encode($_POST['gwapi_recipient_groups']) : json_encode([])
      ?>;
    const _gwapi_import_nonce = <?php echo json_encode(wp_create_nonce('gwapi_import')); ?>;
  </script>
