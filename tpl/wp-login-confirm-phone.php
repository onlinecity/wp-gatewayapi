...
<form method="post" id="<?php echo esc_attr(apply_filters('gwapi_confirm_phone_form_id', 'gwapi_confirm_phone_form')); ?>">

    <input type="hidden" name="gwapi_2f_tmp" value="<?php echo esc_attr($tmp_token); ?>" />
    ...
    <p class="submit">
        <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large"
               ...
               data-loading="<?php esc_attr_e('Confirming...', 'gatewayapi'); ?>">
    </p>
</form>
